import sys
import os
from PyQt5.QtWidgets import QWidget,QLabel,QApplication,QVBoxLayout,QPushButton,QFileDialog,QTextEdit,QHBoxLayout
...
class Menu(QMainWindow):
    ...
    def menuleri_olustur(self):
        ...
        temizle.setShortcut("Ctrl+C")
        cikis = QAction("Çıkış",self)
        cikis.setShortcut("Alt+F4")
    ...
    def response(self,action):
        if(action.text() == "Dosya Aç"):
            ...
            print("Dosya Temizle' ye basıldı")
